...
public class KtormKspExtTest : BaseKspTest() {
    ...
    @Test
    public fun `sequence updateIfNotNull function`() {
            ...
            SourceFile.kotlin(
                ...
                object TestBridge {
                    ...
                    fun updateUser(database: Database) {
                        ...
                        user.username = "tom"
                        user.age = null
                        getUsers(database).updateIfNotNull(user)
                    }
                }
                """,
            )
    ...
    @Test
    public fun `modified entity sequence call updateIfNotNull fun`() {
        val (result1, result2) = twiceCompile(
            SourceFile.kotlin(
                "source.kt",
                """
                ...
                object TestBridge {
                    fun testAdd(database:Database) {
                        ...
                        users.updateIfNotNull(User(1, "lucy", 10))
                    }
                }
                """,
            )
