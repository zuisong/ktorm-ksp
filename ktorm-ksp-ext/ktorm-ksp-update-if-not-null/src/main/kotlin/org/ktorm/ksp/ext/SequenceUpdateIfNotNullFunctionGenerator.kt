...
public class SequenceUpdateIfNotNullFunctionGenerator : TopLevelFunctionGenerator {

    private val update = MemberName("org.ktorm.dsl", "update", true)
    ...
    override fun generate(context: TableGenerateContext, emitter: (FunSpec) -> Unit) {
        ...
        FunSpec.builder("updateIfNotNull")
            .addKdoc(
                """
                updateIfNotNull
            ...
            .addCode(buildCodeBlock {
                ...
                withControlFlow("return·this.database.%M(%T)", arrayOf(update, table.tableClassName)) {
